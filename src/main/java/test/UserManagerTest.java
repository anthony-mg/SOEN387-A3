...
public class UserManagerTest {
    ...
    public void undefinedGroupTest() throws UndefinedUserException, UndefinedGroupException {
    ...
    @Test (expected = UndefinedGroupException.class)
    public void undefinedParentTest() throws UndefinedUserException, UndefinedGroupException {
    ...
    public void undefinedUserTest() throws UndefinedUserException, UndefinedGroupException {
